                ...
                <div className="row justify-content-center mb-5">
                    <div className="col-8 col-md-6 col-lg-4 text-center mb-4">
                        <div className="card h-100 border-success">
                            <a href="https://shannonleahwatson.co.uk/" target="_blank" rel="noreferrer"><img src={slw} className="card-img-top w-75 ml-auto mr-auto" alt="Shannon Leah Watson" /></a>
                    ...
                    <div className="col-8 col-md-6 col-lg-4 text-center mb-4">
                        <div className="card h-100 border-success">
                            <a href="https://chrome.google.com/webstore/detail/colourmail/aaghgjfphjnnamaoadafmijgmgnnpglo" target="_blank" rel="noreferrer"><img src={colourmail} className="card-img-top w-75 ml-auto mr-auto" alt="ColourMail Extension" /></a>
                            <div className="card-body">
                    ...
                    <div className="col-8 col-md-6 col-lg-4 text-center mb-4">
                        <div className="card h-100 border-success">
                            <a href="https://aftts-91e86.web.app/" target="_blank" rel="noreferrer"><img src={aftts} className="card-img-top w-75 ml-auto mr-auto" alt="Adam Foot's TTS" /></a>
                            <div className="card-body">
                    ...
                    <div className="col-8 col-md-6 col-lg-4 text-center mb-4">
                        <div className="card h-100 border-success">
                            <a href="https://gamesreview-6e2f4.web.app/" target="_blank" rel="noreferrer"><img src={gr} className="card-img-top w-75 ml-auto mr-auto" alt="Games Review" /></a>
                            <div className="card-body">
                    ...
                    <div className="col-8 col-md-6 col-lg-4 text-center mb-4">
                        <div className="card h-100 border-success">
                            <a href="https://atn3-s-warzone-s.web.app/" target="_blank" rel="noreferrer"><img src={wzstats} className="card-img-top w-75 ml-auto mr-auto" alt="ATN3's Warzone Stats" /></a>
                            <div className="card-body">
