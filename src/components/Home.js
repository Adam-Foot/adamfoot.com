        ...
        <div className="row">
            <div className="col-12 col-md-8 col-lg-7">
                <p>My name is Adam Foot and I am a recent Computing BSc graduate. I attended the University of
                    ...
                    part in a year in industry where I was lucky enough to land a position with BT in Cardiff,
                    Wales. After I graduated I was offered a place at BT on their 2 year graduate scheme of which I
                    accepted. I am currently working on adding security to BT & EE's Mobile Network platforms.</p>
            </div>
        </div>
        ...
        <div className="row mb-5">
            <div className="col-12 col-md-8 col-lg-7">
                <p>Although I have a current full-time position as a Graduate Software Engineer, I would love to hear
                    about any opportunities that I may be suitable for! So if you have any work that fits my criteria I
